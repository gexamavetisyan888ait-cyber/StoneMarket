...
const partners = [
    ...
    { id: 6, name: "Mane Tiles", logo: "https://stonemarket.am/_next/image?url=%2Fimages%2Fmane-tiles.png&w=3840&q=75https://api.dicebear.com/7.x/initials/svg?seed=MT&backgroundColor=f1f1f1" },
...
const PartnerCard = ({ logo, name }) => (
    <div className="group bg-white rounded-md shadow-md p-6 flex flex-col items-center justify-between transition-all duration-300 hover:shadow-2xl h-30 cursor-pointer">
